...
import pytest
from source_mollie.source import MollieStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MollieStream, "path", "v0/example_endpoint")
    mocker.patch.object(MollieStream, "primary_key", "test_primary_key")
    mocker.patch.object(MollieStream, "__abstractmethods__", set())
